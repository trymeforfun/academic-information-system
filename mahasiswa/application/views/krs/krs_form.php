 ...
 <input type="hidden" name="id_thn_akad" class="form-control" id="id_thn_akad" value="<?= $id_thn_akad ?>">
                ...
                <div class="form-group">
                    ...
                    <?php
                        ...
                        $query = $this->db->query('SELECT kode_matakuliah,nama_matakuliah FROM matakuliah, mahasiswa WHERE mahasiswa.nim ='. $username .' AND matakuliah.id_prodi = mahasiwa.id_prodi');
