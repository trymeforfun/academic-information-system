...
<div class="box">
    <div class="box-body">
        ...
        <?= anchor(site_url('thn_akad_semester/create'),'<i class ="fa fa-file-text" aria-hidden="true"></i>&nbsp;Create', 'class="btn btn-primary"');
        ?>
        </div>
        </div>
    </div>
    ...
    <script type ="text/javascript">
        ...
        (function () {
            ...
            var t = $("#mytable").dataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: {"url": "thn_akad_semester/json", "type": "POST"},
                columns:[
                    {
                        "data": "id_thn_akad",
                        "orderable": false
