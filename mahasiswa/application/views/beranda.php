      ...
      <ul class="sidebar-menu" data-widget="tree">
        <?php
          ...
          foreach ($main_menu->result() as $main){
            ...
            $sub_menu = $this->db->get_where('menu', ['main_menu' => $main->id_menu, 'level' => $level]);
    ...
    <section class="content">
      ...
      <div class="col-sm-4 col-md-2">
        ...
        <div class="color-palette-set">
          <a href="<?= site_url('users');?>"><center><i class="fa fa-user" style="font-size:48px; color:#3c8dbc"></i></center></a>
        </div>
      </div>
      <div class="col-sm-4 col-md-2">
        ...
        <div class="color-palette-set">
          <a href="<?= site_url('matakuliah');?>"><center><i class="fa fa-bookmark" style="font-size:48px; color:#3c8dbc"></i></center></a>
        </div>
      </div>
      <div class="col-sm-4 col-md-2">
