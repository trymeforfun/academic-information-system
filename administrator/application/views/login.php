...
<div class="login-box" id="box">
    ...
    <div class="login-box-body">
      <center><img width="25px" src="<?= base_url('assets/')?>images/ekoenergi.jpg" id="uhkimage" class="rounded-circle" alt=""></center>
...
<form action="<?= base_url('login/proses'); ?>" method="post" class="user">
    ...
    <div class="row">
        ...
        <a href="<?= base_url('auth/registration'); ?>">Register new membership</a>
