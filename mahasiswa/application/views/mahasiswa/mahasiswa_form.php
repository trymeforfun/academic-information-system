        ...
        <input type="hidden" class="form-control" name="photo" id="photo" value="<?= $photo ?>" >
            ...
            <div class="form-group">
                <label class="col-sm-2"for="char">Nomor Mahasiswa</label>
                    <div class="col-sm-4">
                     <input type="text" name="nim" id="nim" class="form-control" placeholder="Nim" value="<?= $nim ?>" readonly/>
                     <?= form_error('nim') ?>
                    </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-sm-2" for="enum">Prodi</label>
                    <div class="col-sm-4">
                     <?php
                        ...
                        foreach($dropdowns as $dropdown){
                            ?>
                        <input type="text" class="form-control" placeholder="Program Studi" value="<?= $dropdown->nama_prodi ?>" readonly />

                        <input type="text" name="id_prodi" id="id_prodi" placeholder="Program Studi" value="<?= $dropdown->id_prodi; ?>"hidden />
                        <?
                        }
