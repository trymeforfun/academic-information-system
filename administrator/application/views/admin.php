...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Hi.. <?= $username; ?> Selamat datang di <?= $univ; ?>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      ...
      <div class="col-sm-4 col-md-2">
        <h4 class="text-center"><span class="info-box-text">Mahasiswa</span></h4>            
          <div>
            <a href="<?= site_url('mahasiswa');?>"><center><i class="fa fa-user" style="font-size:48px; color:#3c8dbc"></i></center></a>
          </div>
      </div>
      ...
      <div class="col-sm-4 col-md-2">
        ...
        <div class="color-palette-set">
          <a href="<?= site_url('thn_akad_semester');?>"><center><i class="fa fa-calendar-o" style="font-size:48px; color:#3c8dbc"></i></center></a>
        </div>
      </div>
      ...
      <div class="col-sm-4 col-md-2">
        ...
        <div class="color-palette-set">
          <a href="<?= site_url('krs');?>"><center><i class="fa fa-edit" style="font-size:48px; color:#3c8dbc"></i></center></a>
        </div>
      </div>
      <!-- /.col -->
      <div class="col-sm-4 col-md-2">
        ...
        <div class="color-palette-set">
          <a href="<?= site_url('nilai');?>"><center><i class="fa fa-file-text-o" style="font-size:48px; color:#3c8dbc"></i></center></a>
        </div>
      </div>
      <!-- /.col -->
      <div class="col-sm-4 col-md-2">
        ...
        <div class="color-palette-set">
          <a href="<?= site_url('inputNilai');?>"><center><i class="fa fa-sort-numeric-asc" style="font-size:48px; color:#3c8dbc"></i></center></a>
        </div>
      </div>
      ...
      <div class="col-sm-4 col-md-2">
        ...
        <div class="color-palette-set">
          <a href="<?= site_url('buatTranskrip');?>"><center><i class="fa fa-print" style="font-size:48px; color:#3c8dbc"></i></center></a>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="color-palette-set">
          <a href="<?= site_url('kategori');?>"><center><i class="fa fa-server" style="font-size:48px; color:#3c8dbc"></i></center></a>
        </div>
      </div>
      ...
      <div class="col-sm-4 col-md-2">
        ...
        <div class="color-palette-set">
          <a href="<?= site_url('informasi');?>"><center><i class="fa fa-globe" style="font-size:48px; color:#3c8dbc"></i></center></a>
        </div>
      </div>
      ...
      <div class="col-sm-4 col-md-2">
        ...
        <div class="color-palette-set">
          <a href="<?= site_url('identitas');?>"><center><i class="fa fa-vcard-o" style="font-size:48px; color:#3c8dbc"></i></center></a>
        </div>
      </div>
      ...
      <div class="col-sm-4 col-md-2">
        ...
        <div class="color-palette-set">
          <a href="<?= site_url('tentang_Kampus');?>"><center><i class="fa fa-info" style="font-size:48px; color:#3c8dbc"></i></center></a>
        </div>
      </div>
      ...
      <div class="col-sm-4 col-md-2">
        ...
        <div class="color-palette-set">
          <a href="<?= site_url('fasilitas');?>"><center><i class="fa fa-suitcase" style="font-size:48px; color:#3c8dbc"></i></center></a>
        </div>
      </div>
      ...
      <div class="col-sm-4 col-md-2">
        ...
        <div class="color-palette-set">
          <a href="<?= site_url('gallery');?>"><center><i class="fa fa-photo" style="font-size:48px; color:#3c8dbc"></i></center></a>
        </div>
      </div>
</div>
        </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018-2019 <a href="#">Okky Tirta Kurniawan</a>.</strong> All rights
    reserved.
  </footer>
